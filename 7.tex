...
First observe that $x^{q^n}-x$ is seperable, being
...
divides $x^{q^n}-x$. Now since $\alpha$ satisifes $x^{q^d}-x$
...
divies $x^{q^n}-x$ and proves \autoref{Theorem2}.
...
Thus, there exist monic irredubile polynomials of degree~$n$
